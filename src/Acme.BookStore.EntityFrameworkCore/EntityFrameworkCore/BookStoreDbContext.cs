    ...
    ITenantManagementDbContext
{
    ...
    public DbSet<APITest> APIvalues { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Book>(b => {
            //BookStoreConsts 含有用于表的架构和表前缀的常量值
        ...
        builder.Entity<APITest>(b => {
            //BookStoreConsts 含有用于表的架构和表前缀的常量值
            b.ToTable(BookStoreConsts.DbTablePrefix + "APIs", BookStoreConsts.DbSchema);
            //ConfigureByConvention() 方法优雅的配置/映射继承的属性,应对所有的实体使用它.
            b.ConfigureByConvention(); //auto configure for the base class props
